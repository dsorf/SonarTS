...
public class SonarTSCoreBundle implements ExecutableBundle {
  ...
  public SonarTSCoreBundle(File baseDir, Configuration configuration) {
    this.configuration = configuration;

    this.sonartsRunnerExecutable = new File(baseDir, BIN + "tsrunner");
    this.sonartsServerExecutable = new File(baseDir, BIN + "sonarts-server");
  }
